...
// Admin: create advice and broadcast
router.post('/', auth, admin, async (req, res) => {
  try {
    ...
    // Broadcast to all clients about new advice (no text)
...
// Get latest advice metadata for a category
...
// Unlock an advice: deduct from wallet and return full text
router.post('/:id/unlock', auth, async (req, res) => {
  try {
    ...
    // If already purchased, return without charging again
